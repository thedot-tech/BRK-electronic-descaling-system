...
export default ({
  subheading = "Research",
  heading = <>We Love <span tw="text-primary-500">Creating Products.</span></>,
  description = "We love developing and creating amazing products, which would revolutionize water treatment process.",
